...
public interface ProductSaleRepository extends JpaRepository<ProductSale, Long> {
        ...
        @Query("SELECT new com.iyadsoft.billing_craft_backend.dto.SupplierDetailsDto(ps.date, ps.customer.cid, CAST(0 AS long), 0.0, SUM(ps.productStock.pprice), 0.0, 0.0, 'No') "
                        +
                        "FROM ProductSale ps " +
